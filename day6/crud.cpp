...
public:
    ...
    {
        int n;
        cout << "Enter the number of elements you want to insert intaially : ";
        cin >> n;
        ...
        cout << "Enter" << n << "element one by one: \n";
        for (int i = 0; i < n; i++)
        {
            int value;
            cout << "Element" << (i + 1) << ":";
        ...
        cout << "\n Intial elements insrerted successfully! \n \n";
        display(); // show array after intial insertion
    }
